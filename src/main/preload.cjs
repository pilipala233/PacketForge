    ...
    contextBridge.exposeInMainWorld('packetforge', {
        ...
        api: {
            ...
            mitm: {
                ...
                pause: () => ipcRenderer.invoke('mitm:pause'),
                resume: () => ipcRenderer.invoke('mitm:resume'),
            ...
            utils: {
                ...
                selectFile: (payload) => ipcRenderer.invoke('utils:selectFile', payload),
                showItemInFolder: (filePath) =>
                    ipcRenderer.invoke('utils:showItemInFolder', filePath),
